...
int main(){
	 ...
	 c.blue=0;
	 c.green=0;
	 fig1 = start_figure(500,500);
	 set_thickness_resolution(fig1,0.5,2);
	 set_color(fig1,c);
	 ...
	 set_thickness_resolution(fig2,0.5,0.5);
	 set_color(fig2,c);
	...
	fig4= start_figure(500,500);
	set_thickness_resolution(fig4,0.5,0.5);
	set_color(fig4,c);
    ...
    fig5= start_figure(500,500);
    set_thickness_resolution(fig5,0.5,0.5);
	set_color(fig5,c);
